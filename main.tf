...
resource "aws_subnet" "public" {
  ...
  ipv6_cidr_block = var.enable_ipv6 && length(var.public_subnet_ipv6_prefixes) > 0 ? cidrsubnet(aws_vpc.usbank_vpc[0].ipv6_cidr_block, 8, var.public_subnet_ipv6_prefixes[count.index]) : null
...
resource "aws_subnet" "private" {
  ...
  ipv6_cidr_block = var.enable_ipv6 && length(var.private_subnet_ipv6_prefixes) > 0 ? cidrsubnet(aws_vpc.usbank_vpc[0].ipv6_cidr_block, 8, var.private_subnet_ipv6_prefixes[count.index]) : null
...
resource "aws_subnet" "database" {
  ...
  ipv6_cidr_block = var.enable_ipv6 && length(var.database_subnet_ipv6_prefixes) > 0 ? cidrsubnet(aws_vpc.usbank_vpc[0].ipv6_cidr_block, 8, var.database_subnet_ipv6_prefixes[count.index]) : null
...
resource "aws_db_subnet_group" "database" {
  ...
  name        = lower(var.dbname)
  description = "Database subnet group for ${var.dbname}"
  subnet_ids  = aws_subnet.database.*.id

  tags = merge(
    {
      "Name" = format("%s", var.dbname)
    },
    var.tags,
...
resource "aws_subnet" "redshift" {
  ...
  ipv6_cidr_block = var.enable_ipv6 && length(var.redshift_subnet_ipv6_prefixes) > 0 ? cidrsubnet(aws_vpc.usbank_vpc[0].ipv6_cidr_block, 8, var.redshift_subnet_ipv6_prefixes[count.index]) : null
...
resource "aws_subnet" "elasticache" {
  ...
  ipv6_cidr_block = var.enable_ipv6 && length(var.elasticache_subnet_ipv6_prefixes) > 0 ? cidrsubnet(aws_vpc.usbank_vpc[0].ipv6_cidr_block, 8, var.elasticache_subnet_ipv6_prefixes[count.index]) : null
...
resource "aws_subnet" "intra" {
  ...
  ipv6_cidr_block = var.enable_ipv6 && length(var.intra_subnet_ipv6_prefixes) > 0 ? cidrsubnet(aws_vpc.usbank_vpc[0].ipv6_cidr_block, 8, var.intra_subnet_ipv6_prefixes[count.index]) : null
...
resource "aws_default_network_acl" "this" {
  ...
  default_network_acl_id = element(concat(aws_vpc.usbank_vpc.*.default_network_acl_id, [""]), 0)
...
resource "aws_network_acl" "public" {
  ...
  vpc_id     = element(concat(aws_vpc.usbank_vpc.*.id, [""]), 0)
